          ...
          <div className="flex flex-col">
            <div className="flex justify-between">
              ...
              <div className="flex text-neutral-400 ml-auto gap-2 text-sm items-center ">
                ...
                <button
                  className={`rounded-md px-4 py-2 gap-2 flex border-neutral-300 border ${selected === 2 ? " text-black border-neutral-800 " : ""}`}
                ...
                <button
                  className={`rounded-md px-4 py-2 gap-2 flex border-neutral-300 border ${selected === 3 ? " text-black border-neutral-800 " : ""}`}
